...
class ConfusionMatrix(DataExportMixin):
    ...
    def plot(self, normalize: bool = True, save_dir: str = "", on_plot=None):
        ...
        with plt.rc_context({
            ...
            ax.set_xlabel("True", fontsize=label_fontsize, fontweight="bold", labelpad=6)
            ax.set_ylabel("Predicted", fontsize=label_fontsize, fontweight="bold", labelpad=6)
            ...
            fig.subplots_adjust(left=0, right=0.92, top=0.94, bottom=btm)  # Adjust layout to ensure equal margins
